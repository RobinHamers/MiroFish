...
class RetryableAPIClient:
    ...
    def call_with_retry(
        ...
        **kwargs
        ...
        """
        Execute function call and retry upon failure.
    ...
    def call_batch_with_retry(
        ...
        """
        Batch call and retry for each failed item independently.
        
        Args:
            items: List of items to process
            process_func: Processing function, receiving a single item
            exceptions: Exception types to retry on
