"""Zep Graph paginated reading tools.
...
def fetch_all_nodes(
    ...
    """Retrieve graph nodes with pagination, returning at most max_items (default 2000). Retries each page request."""
    all_nodes: list[Any] = []
...
def fetch_all_edges(
    ...
    """Retrieve all graph edges with pagination, returning a complete list. Retries each page request."""
    all_edges: list[Any] = []
    cursor: str | None = None
    page_num = 0
