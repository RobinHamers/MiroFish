...
Manages parallel simulations for Twitter and Reddit platforms.
...
class SimulationState:
    ...
    def to_simple_dict(self) -> Dict[str, Any]:
        """Simplified state dictionary (For API returns)"""
        return {
            "simulation_id": self.simulation_id,
            "project_id": self.project_id,
            "graph_id": self.graph_id,
...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        5. Preparation complete (preset scripts remain in scripts directory).
        ...
        try:
            ...
            # Set real-time output file path (prioritize Reddit JSON format)
            ...
            # Reddit is already saved real-time during generation, saving again here to ensure completeness
            if progress_callback:
                progress_callback(
            ...
            # Note: Run scripts remain in backend/scripts/ directory
            # Simulation_runner will run them from there
