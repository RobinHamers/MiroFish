...
class ZepEntityReader:
    ...
    2. Filter nodes matching predefined entity types (Labels other than just Entity).
    3. Obtain related edge and associated node information for each entity.
    """
    ...
    def filter_defined_entities(
        ...
        Filtering logic:
        - If node's Labels only contain "Entity", it doesn't match our predefined types, skip.
        - If node's Labels contain labels other than "Entity" and "Node", it matches predefined types, keep.
        
        Args:
            graph_id: Graph ID
            defined_entity_types: List of predefined entity types (optional)
            enrich_with_edges: Whether to obtain related edge information for each entity
            
        Returns:
            FilteredEntities: Set of filtered entities
        """
        ...
        for node in all_nodes:
            ...
            # Check if matching predefined types if specified
    ...
    def get_entities_by_type(
        ...
        Args:
            ...
            enrich_with_edges: Whether to obtain related edge information
