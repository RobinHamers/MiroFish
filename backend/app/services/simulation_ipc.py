    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Specified platform (optional)
                ...
                - None: Interview on both platforms for dual-platform simulation, or on the only available platform for single-platform simulation
            timeout: Timeout
            
        Returns:
            IPCResponse, the result field contains interview results
        """
        args = {
            "agent_id": agent_id,
            "prompt": prompt
