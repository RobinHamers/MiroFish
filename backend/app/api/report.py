...
def chat_with_report_agent():
    ...
    The Report Agent can autonomously call retrieval tools during dialogue to answer questions.
    ...
    try:
        ...
        # Create Agent and perform dialogue
        agent = ReportAgent(
            graph_id=graph_id,
            simulation_id=simulation_id,
            simulation_requirement=simulation_requirement
...
# ============== Report Progress and Sectioned Output Interfaces ==============
...
def get_agent_log(report_id: str):
    ...
    - Every section's start, tool calls, LLM responses, completion
...
def get_console_log(report_id: str):
    ...
    providing plain-text console-style logs.
