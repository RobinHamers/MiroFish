...
class IPCHandler:
    ...
    async def handle_batch_interview(self, command_id: str, interviews: List[Dict]) -> bool:
        ...
        try:
            ...
            actions = {}
            agent_prompts = {}  # Track prompt for each agent
...
class TwitterSimulationRunner:
    ...
    def _create_model(self):
        ...
        Uses project root .env configuration (highest priority):
        - LLM_API_KEY: API key
        - LLM_BASE_URL: API base URL
        - LLM_MODEL_NAME: Model name
        """
        # Prioritize loading config from .env
    ...
    def _get_active_agents_for_round(
        ...
        # Calculate activation probability for each Agent based on configuration
        candidates = []
...
def setup_signal_handlers():
    ...
    Allows the program to clean up resources normally (close databases, environments, etc.)
    """
