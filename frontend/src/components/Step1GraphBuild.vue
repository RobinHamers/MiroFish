    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Based on the generated ontology, documents are auto-chunked and sent to Zep to build a knowledge graph, extract entities and relations, and form temporal memory with community summaries
          </p>
