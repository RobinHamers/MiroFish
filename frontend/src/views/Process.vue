      ...
      <div class="left-panel" :class="{ 'full-screen': isFullScreen }">
        ...
        <div class="graph-container" ref="graphContainer">
          ...
          <div v-else-if="currentPhase < 1" class="graph-waiting">
            ...
            <p class="waiting-hint">Graph construction will start automatically upon completion</p>
          </div>
        ...
        <div class="process-content">
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
            ...
            <div class="phase-detail">
              ...
              <div class="detail-section" v-if="projectData?.ontology">
                <div class="detail-label">Relationship Types ({{ projectData.ontology.relation_types?.length || 0 }})</div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">Description</div>
                <div class="detail-content">
                  Based on the generated ontology, the document is chunked and the Zep API is called to build a knowledge graph, extracting entities and relationships.
                </div>
              </div>
...
const goToNextStep = () => {
  // Use simulation creation endpoint
  router.push({ name: 'Simulation', params: { simulationId: 'new' }, query: { projectId: currentProjectId.value } })
}
...
const initProject = async () => {
  ...
  if (paramProjectId === 'new') {
    // New project: get pending data from store
